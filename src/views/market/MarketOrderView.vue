<template>
    ...
    <BaseContainer heading="Market Orders List">
                ...
                <table class="table table-bordered table-striped table-hover" id="datatable">
                    ...
                    <tbody>
                        <tr v-for="(order, index) in ordersList" :key="order.id" @click="showOrderById(order.id)"
                            ...
                            <td>{{ order.market_order_number }}</td>
                            <td>
...
import { fetchMarketOrdersList } from "@/core/repos/admin/common/marketOrderRepos";
...
function showItemById(id) {
    router.push({ name: "marketorderdetails", params: { id } });
}
